...
import {XlsxImportPhylibService} from '../shared/services/xlsx-import-phylib.service';
import {ValExceltabsService} from '../shared/services/val-exceltabs.service';
...
import {PhytoseeServiceService} from 'src/app/shared/services/phytosee-service.service';
 ...
 */
  ausblendenDVNR(){
	...
	if (this.ArtenNichtBekannt===true){
		const MessDataImpoD: Messwerte[] = this.xlsxImportPhylibService.MessDataImp.filter(item => typeof item._Taxon === 'string' && !item._Taxon.includes(''));
